...
pub fn from_expr<'a: 'de, 'de, T: serde::Deserialize<'de>>(expr: &'a Expr) -> Result<T, Error> {
    T::deserialize(Deserializer { expr })
}
...
impl<'de> serde::de::Deserializer<'de> for Deserializer<'de> {
    ...
    fn deserialize_any<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        match self.expr {
            ...
            Expr::Lit(lit) => match lit {
                ...
                _ => Err(Self::Error::UnexpectedExpr(self.expr.clone())),
            },
    ...
    fn deserialize_bytes<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        match self.expr {
            Expr::Lit(Lit::Str(str)) => visitor.visit_borrowed_bytes(str.value.as_bytes()),
            Expr::Lit(lit) => Err(Error::unexpected_lit(lit, expected)),
            Expr::Object(_) => Err(Self::Error::invalid_type(Unexpected::Map, &expected)),
            Expr::Array(_) => Err(Self::Error::invalid_type(Unexpected::Seq, &expected)),
            other => Err(Self::Error::UnexpectedExpr(other.clone())),
    ...
    fn deserialize_enum<V: Visitor<'de>>(
        ...
        match self.expr {
            Expr::Lit(Lit::Str(str)) => visitor.visit_enum(str.value.as_str().into_deserializer()),
            Expr::Lit(lit) => Err(Error::unexpected_lit(lit, expected)),
    ...
    fn deserialize_map<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        match self.expr {
            Expr::Object(ObjectLit { props, .. }) => visitor.visit_map(Map {
                fields: props.iter(),
                value: None,
            }),
            other => Err(Self::Error::UnexpectedExpr(other.clone())),
    ...
    fn deserialize_seq<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        match self.expr {
            Expr::Array(ArrayLit { elems, .. }) => visitor.visit_seq(Seq {
                values: elems.iter(),
            }),
            other => Err(Self::Error::UnexpectedExpr(other.clone())),
        }
    ...
    fn deserialize_str<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        match self.expr {
            Expr::Lit(Lit::Str(str)) => visitor.visit_borrowed_str(str.value.as_str()),
            Expr::Lit(lit) => Err(Error::unexpected_lit(lit, expected)),
            Expr::Object(_) => Err(Self::Error::invalid_type(Unexpected::Map, &expected)),
            Expr::Array(_) => Err(Self::Error::invalid_type(Unexpected::Seq, &expected)),
            other => Err(Self::Error::UnexpectedExpr(other.clone())),
...
struct Seq<'de> {
    values: std::slice::Iter<'de, Option<ExprOrSpread>>,
}
...
struct Map<'de> {
    fields: std::slice::Iter<'de, PropOrSpread>,
    value: Option<&'de Expr>,
}
                ...
                PropOrSpread::Prop(prop) => match &**prop {
                    Prop::KeyValue(kvp) => {
                        ...
                        let key_str = prop_name_to_str(&kvp.key)
                            .ok_or_else(|| Error::UnexpectedProp(Box::new(*prop.clone())))?;
...
impl<'de> VariantAccess<'de> for Enum<'de> {
    ...
    fn unit_variant(self) -> Result<(), Self::Error> {
        Err(Self::Error::UnexpectedExpr(self.value.clone()))
    }
